...
class UdpComms():
    def __init__(self,udpIPServer,udpIPClient,portTX,portRX,enableRX=False,suppressWarnings=True):
        """
        Constructor
        :param udpIPServer: Must be string e.g. "127.0.0.1"
        :param udpIPClient: Must be string e.g. "127.0.0.1"
        ...
        self.udpIPServer = udpIPServer
        self.udpIPClient = udpIPClient
        ...
        self.udpSock.bind((udpIPServer, portRX))
    ...
    def SendDataToServer(self, strToSend):
        # Use this function to send string to C#
        self.udpSock.sendto(bytes(strToSend,'utf-8'), (self.udpIPServer, self.udpSendPort))

    def SendDataToClient(self, strToSend):
        # Use this function to send string to C#
        self.udpSock.sendto(bytes(strToSend,'utf-8'), (self.udpIPClient, self.udpSendPort))
