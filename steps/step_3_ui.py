...
class Step_3_UI(qtw.QWidget):
  def __init__(self, my_initializer):
    ...
    self.ui = uic.loadUi(f'ui/{my_initializer.lang}/{my_initializer.hand}/food_assist_gui_step3.ui', self)
  ...
  def next_button_pressed(self):
    self.obj.deactivate()
    self.target_ui = fa.Entry_Step_4_UI(self.my_initializer)
  ...
  def exit_button_pressed(self):
    self.obj.deactivate()
    self.my_initializer.last_class = Step_3_UI
